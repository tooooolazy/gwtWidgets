...
import com.tooooolazy.gwt.widgets.client.utils.DateUtils;
...
public class CalendarModel implements Multilingual {
	...
	public String formatCurrentMonth() {
		return getMessage("month." + currentMonth.getMonth() + ".full") + " " + DateUtils.year(currentMonth);
	}
	...
	public String formatDayOfWeek(int dayInWeek) {
		return getMessage("day." + dayInWeek + ".short");//dayOfWeekNames[dayInWeek];
	}
	...
	public void setCurrentMonth(Date currentDate) {
		...
		this.currentMonth.setHours(currentDate.getHours());
		this.currentMonth.setMinutes(currentDate.getMinutes());
	}
	...
	public void setCurrentMinutes(int minutes) {
		currentMonth.setMinutes(minutes);
		refresh();
	}
	public void setCurrentHours(int hours) {
		currentMonth.setHours(hours);
		refresh();
	}

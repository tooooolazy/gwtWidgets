 ...
 * 
 */
abstract class DatePickerComponent extends Composite implements Multilingual {
	...
	protected void setMinutes(int minutes) {
		getModel().setCurrentMinutes(minutes);
		getDatePicker().refreshAll();
	}
	protected void setHours(int hours) {
		getModel().setCurrentHours(hours);
		getDatePicker().refreshAll();
	}
	...
	/**
	 * Refresh the component. Usually called because the model's current date
	 * has changed. In general, only should be called by {@link DatePicker}. Use
	...
	public String getMessage(String key) {
		return datePicker.getMessage( key );
	}
	@Override

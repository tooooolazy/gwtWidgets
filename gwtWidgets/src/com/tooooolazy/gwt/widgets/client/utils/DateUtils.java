...
public class DateUtils {
	...
	public static int differenceInDays(Date endDate, Date startDate) {
		...
		if (!areOnTheSameDay(endDate, startDate)) {
			...
			double differenceDouble = (double) Math.abs(endDateInstant
					- startDateInstant)
	...
	public static Date firstOfNextMonth(Date date) {
		...
		if (date != null) {
			int year = date.getMonth() == 11 ? date.getYear() + 1 : date
					.getYear();
	 ...
	 * @return A new date object representing passed object
	 */
